...
import { Package, Search, Filter, Eye, DollarSign, Calendar, Truck, AlertTriangle, MapPin, Users, Briefcase } from 'lucide-react';
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                        ...
                        Order & Partner Management
                    </h1>
                    <p className="text-gray-500 mt-1">Manage customer orders, shipments, returns and partners</p>
                </div>
                {activeTab === 'orders' && (
            ...
            <div className="flex gap-4 mb-6 border-b border-gray-200">
                <button
                    ...
                    className={`pb-3 px-1 text-sm font-medium transition-colors relative ${activeTab === 'orders'
                        ? 'text-emerald-600'
                ...
                <button
                    ...
                    className={`pb-3 px-1 text-sm font-medium transition-colors relative ${activeTab === 'partners'
                        ? 'text-emerald-600'
                        : 'text-gray-500 hover:text-gray-700'
                        }`}
                >
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    ...
                                                    {order.coordinates && (
                                                        <a
                                                            ...
                                                            className="inline-flex items-center justify-center p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all ml-1"
                                                            title="View Location"
                                                        >
