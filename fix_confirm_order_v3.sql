-- Emergency Fix V3 for confirm_order
...
BEGIN
  ...
  -- ACCOUNTING ENTRIES
  -- Fix: Added 'ledger_type' -> 'Sales' (assuming text/enum)
  INSERT INTO accounting_ledger (description, reference_id, reference_type, ledger_type)
  VALUES ('Order Confirmation #' || p_order_id, p_order_id, 'order', 'Sales')
